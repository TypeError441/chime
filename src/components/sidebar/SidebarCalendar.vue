...
import { useStats, useSchool, useSidebarOpened } from "../../composables/settings";
...
const displayedPeriods = computed(() => {
    ...
    return periods.map((p) => {
        ...
        return {
            ...
            height: Math.max((end - start) * 1.95, ((end - start) * 2) - 5),
...
<template>
  <div v-if="currentSchedule" class="sidebar--schedule">
    <CalendarItem
